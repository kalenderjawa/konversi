...
function MasehiKeHijriyah(date, adjustment) {
  ...
  let islamicDateObject = {
    dayOfWeekText: iHariHijriyah[iDate[4]],
    dayOfWeek: iDate[4] + 1,
    dayOfMonth: iDate[5],
    month: iDate[6] + 1,
    monthText: iBulanHijriyah[iDate[6]],
    year: iDate[7],
  };
  return islamicDateObject;
}

export { MasehiKeHijriyah };
